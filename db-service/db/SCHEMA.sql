...
-- -----------------------------------------------------
-- Table `Product_Configurator`.`ACCOUNT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Product_Configurator`.`ACCOUNT` ;

CREATE TABLE IF NOT EXISTS `Product_Configurator`.`ACCOUNT` (
...
CREATE TABLE IF NOT EXISTS `Product_Configurator`.`CONFIGURATIONS` (
  ...
  INDEX `fk_CONFIGURATIONS_ACCOUNT1_idx` (`ACCOUNT_id` ASC) VISIBLE,
  CONSTRAINT `fk_BOOKINGS_PRODUCTS1`
    FOREIGN KEY (`product_number`)
    REFERENCES `Product_Configurator`.`PRODUCTS` (`product_number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CONFIGURATIONS_ACCOUNT1`
    FOREIGN KEY (`ACCOUNT_id`)
    REFERENCES `Product_Configurator`.`ACCOUNT` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Product_Configurator`.`PRODUCTS` (
  ...
  INDEX `fk_PRODUCTS_CONFIGURATIONS1_idx` (`base_model` ASC) VISIBLE,
  CONSTRAINT `fk_PRODUCTS_CONFIGURATIONS1`
    FOREIGN KEY (`base_model`)
...
CREATE TABLE IF NOT EXISTS `Product_Configurator`.`BOOKINGS` (
  ...
  INDEX `fk_BOOKINGS_ACCOUNT1_idx` (`ACCOUNT_id` ASC) VISIBLE,
  CONSTRAINT `fk_BOOKINGS_CONFIGURATIONS1`
    FOREIGN KEY (`config_id`)
    REFERENCES `Product_Configurator`.`CONFIGURATIONS` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_BOOKINGS_ACCOUNT1`
    FOREIGN KEY (`ACCOUNT_id`)
    REFERENCES `Product_Configurator`.`ACCOUNT` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
