namespace Model
{
    ...
    {
        public ProductDependencies(int basePrice, List<string> defaultOptions, Dictionary<string, List<string>> replacementGroups, Dictionary<string, List<string>> requirements, Dictionary<string, List<string>> incompabilities, Dictionary<string, int> priceList)
        {
            BasePrice = basePrice;
