...
namespace BackendProductConfigurator.Controllers
{
    public abstract class AValuesClass
    {
        ...
        public static List<ConfiguratorSlim> ProductsSlim { get; set; } = new List<ConfiguratorSlim>();
        ...
        public static void SetStaticValues()
        {
            ...
            List<OptionGroup> optionGroups = new List<OptionGroup> { new OptionGroup() { ConfigId = "COLOR_GROUP", Name = "Color", Description = "What color you want", OptionIds = new List<string>(){ "RED", "WHITE", "GREEN"}, Required = true },
                                                                     new OptionGroup() { ConfigId = "MOTORTYPE_GROUP", Name = "A motor fuel type", Description = "What motor fuel", OptionIds = new List<string>(){ "DIESEL", "PETROL"}, Required = true },
                                                                     new OptionGroup() { ConfigId = "MOTOR_GROUP", Name = "A motor power", Description = "The motor power", OptionIds = new List<string>(){ "D150", "D200", "D250"}, Required = true } };
            ...
            Configurators.Add(new Configurator() { ConfigId = 0, Name = "Neuer Konfigurator", Description = "Sehr cool", Images = productImages, Dependencies = productDependencies, OptionGroups = optionGroups, Options = options, OptionSections = optionSections});

            List<Option> optionsList = new List<Option> { new Option("Option1", "Erste Option", "Ka Ahnung wos des duat") };
            ...
            ConfiguratorSlim ps1 = new ConfiguratorSlim() { //Hier Images hinzufügen, ProductSave anschauen, usw... CLEAN UP
                ConfigId = 0,
                Name = "Fetter Benz",
            ...
            ProductsSlim = new List<ConfiguratorSlim> { ps1, ps2, ps3 };
