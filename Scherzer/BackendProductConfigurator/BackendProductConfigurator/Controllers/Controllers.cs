...
namespace BackendProductConfigurator.Controllers
{
    ...
    public abstract class Controllers<T, K> : ControllerBase where T : class
    {
        ...
        protected Controllers()
        {
            ...
            {
                List<Option> options = new List<Option> { new Option("D150", "Fetter Diesel Motor", new List<string> { "youtube.com" }, "D150"), new Option("D200", "Fetter Diesel Motor", new List<string> { "youtube.com" }, "D200"), new Option("D250", "Fetter Diesel Motor", new List<string> { "youtube.com" }, "D250") };
                ...
                ProductConfig productConfig = new ProductConfig("0", "Alfa Romeo 159", "A really nice car", productImages, productDependencies, options, optionGroups, optionSections);

                values = new List<T> { productConfig as T };
            }
            if (typeof(T) == typeof(Product))
            {
                Product p1 = new Product() { Id = "0", Name = "Fetter Benz", Description = "Laut und groß" };
                Product p2 = new Product() { Id = "1", Name = "Eleganter Alfa Romeo", Description = "Stylisch und erweckt" };
                Product p3 = new Product() { Id = "2", Name = "Fetterer Benz", Description = "Umso lauter und größer" };
    ...
    public class configurationController : Controllers<ProductConfig, string>
    {
    }
